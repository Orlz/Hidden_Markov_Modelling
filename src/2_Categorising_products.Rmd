...
This script is part 2 in the 4-part series. It takes the cleaned sales and product data and classifies it into the 6 product categories of interest. These are described below: 
...
Here, we've been using the pb_to_categorise to extract the catgorised products through via a process of eliminations. We can now see what remains within this data frame: 
```{r check_remaining}
